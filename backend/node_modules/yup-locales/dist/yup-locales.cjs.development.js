...
var mixed$e = {
  ...
  notType: function notType(_ref) {
    var path = _ref.path,
        ...
        originalValue = _ref.originalValue;
    var isCast = originalValue != null && originalValue !== value;
    var msg = path + " mus\xED by\u0165 `" + getTypeTranslation(type) + "`, " + ("ale kone\u010Dn\xE1 hodnota bola: `" + printValue(value, true) + "`") + (isCast ? " (obsadenie z hodnoty `" + printValue(originalValue, true) + "`)." : '.');
...
var mixed$f = {
  ...
  notType: function notType(_ref) {
    var path = _ref.path,
        ...
        originalValue = _ref.originalValue;
    var isCast = originalValue != null && originalValue !== value;
    var msg = "\u041F\u043E\u043B\u0435 " + path + " \u0434\u043E\u043B\u0436\u043D\u043E \u0431\u044B\u0442\u044C  `" + type + "` \u0442\u0438\u043F\u043E\u043C, " + ("\u043D\u043E \u0444\u0438\u043D\u0430\u043B\u044C\u043D\u043E\u0435 \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0435: `" + printValue(value, true) + "` `") + (isCast ? " (\u043F\u0440\u0438\u0432\u0435\u0434\u0435\u043D\u043E \u0438\u0437 \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u044F `" + printValue(originalValue, true) + "`)." : '.');
...
var mixed$g = {
  ...
  notType: function notType(_ref) {
    var path = _ref.path,
        ...
        originalValue = _ref.originalValue;
    var isCast = originalValue != null && originalValue !== value;
    var msg = path + " mus\xED b\xFDt `" + getTypeTranslation$1(type) + "`, " + ("ale kone\u010Dn\xE1 hodnota byla: `" + printValue(value, true) + "`") + (isCast ? " (obsadenie z hodnoty `" + printValue(originalValue, true) + "`)." : '.');

    if (value === null) {
      msg += "\n Pokud je \u201Enull\u201C ur\u010Den\xFD jako pr\xE1zdn\xE1 hodnota, nezapom\u011B\u0148te ozna\u010Dit sch\xE9ma jako" + ' `.nullable()`';
    }
